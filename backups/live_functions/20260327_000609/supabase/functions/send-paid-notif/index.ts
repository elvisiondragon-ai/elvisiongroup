...
const PRODUCT_TEMPLATES: Record<string, any> = {
  ...
  'ebook_feminine_lovemagnet': { sku: "ebookspaid07", subject: "Akses Download: Paket Dark Feminine Anda", downloadLink: "https://drive.google.com/drive/folders/1IZmSrzPDSgGSYwq1sQhhGgBaUExJjhgd?usp=sharing", title: "Akses Dark Feminine Terbuka", lang: "id", instructions: ["Silahkan klik tombol di bawah untuk mendownload seluruh ebook Anda."] },
