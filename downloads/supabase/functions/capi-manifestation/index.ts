...
Deno.serve(async (req) => {
  console.log('--- capi-manifestation Edge Function Start ---');
  ...
  // --- Configuration ---
  const FACEBOOK_PIXEL_ID = '1393383179182528';
  const FACEBOOK_ACCESS_TOKEN = Deno.env.get('FACEBOOK_MANIFESTATION_CAPI');
  ...
  try {
    ...
    console.log('--- capi-manifestation Edge Function End ---');
    ...
    console.error('Unexpected error in capi-manifestation function:', error);
