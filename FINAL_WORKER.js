...
export default {
  async fetch(request, env, ctx) {
    ...
    // Allow both GET and POST for MacroDroid/Webhooks
    ...
    try {
      ...
      // Handle GET parameters (for MacroDroid simplified GET)
      ...
      // CASE D: MacroDroid Notification (General Notification)
      else if (data.notification || data.notif || data.macrodroid) {
          targetTo = ADMIN_DESTINATION;
          const content = data.notification || data.notif || data.macrodroid;
          messageText = `ADA NOTIF ! ${content}`;
          shouldSend = true;
      }
