-- Fixed SQL to sync essential profile fields to user_metadata for instant chat access
...
-- Create the sync function with correct return type
...
SELECT 'Starting metadata sync...' as info;
...
SELECT 'Metadata sync completed successfully!' as result;