    ...
    try {
      ...
      if (error) {
        ...
        const mockMessages: ChatMessageData[] = [
          { id: '1', user_id: '1', user_name: 'Budiyas32', user_level: 3, is_pro: false, message: 'asik banget apknya', created_at: new Date('2024-01-20T09:15:00').toISOString() },
          { id: '2', user_id: '2', user_name: 'dudungsubang', user_level: 2, is_pro: false, message: 'bener lebih mudah denger audionya ada historynya lagi', created_at: new Date('2024-01-20T09:16:00').toISOString() },
          { id: '3', user_id: '3', user_name: 'andiniwati', user_level: 2, is_pro: false, message: 'iya jadi betah diam di aplikasi', created_at: new Date('2024-01-20T09:16:30').toISOString() },
          ...
          { id: '5', user_id: '5', user_name: 'Andin', user_level: 9, is_pro: false, message: 'bener mas anto, seru ngejar poinnya hehe', created_at: new Date('2024-01-20T09:18:30').toISOString() },
          { id: '6', user_id: '6', user_name: 'Master Yoga', user_level: 8, is_pro: false, message: 'Peringkatku naik terus nih, jadi semangat', created_at: new Date('2024-01-20T09:19:00').toISOString() },
          { id: '7', user_id: '7', user_name: 'SitiAisyah', user_level: 2, is_pro: false, message: 'fitur history itu yg paling ngebantu aku sih', created_at: new Date('2024-01-20T09:22:00').toISOString() },
          { id: '8', user_id: '8', user_name: 'EkoPrasetyo', user_level: 2, is_pro: false, message: 'setuju, ga perlu cari ulang audio yg kemarin didengerin', created_at: new Date('2024-01-20T09:22:30').toISOString() },
          { id: '9', user_id: '9', user_name: 'IwanSetiawan', user_level: 2, is_pro: false, message: 'Tampilannya juga bersih, ga ribet, enak diliat', created_at: new Date('2024-01-20T09:25:00').toISOString() },
          { id: '10', user_id: '10', user_name: 'DewiLestari90', user_level: 1, is_pro: false, message: 'baru download kemarin, langsung sukaa', created_at: new Date('2024-01-20T09:30:00').toISOString() },
          ...
          { id: '29', user_id: 'srcindocs@gmail.com', user_name: 'Admin_Renata', user_level: 10, is_pro: true, message: 'Belum bisa kak Indah, tapi ditunggu aja updatenya ya :)', created_at: new Date('2024-01-20T12:05:00').toISOString() },
