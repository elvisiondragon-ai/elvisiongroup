...
export function Home({
  ...
  useEffect(() => {
    ...
    setIsPWAFullscreen(window.matchMedia('(display-mode: fullscreen)').matches);
  }, []);
  ...
  return <div className="min-h-screen bg-background pb-20">
        ...
        <div className="h-64 bg-gradient-to-br from-gray-900 via-slate-950 to-purple-950" >
          ...
          <div className="relative h-full flex items-end p-6">
            <div className="flex items-center gap-4">
              <img src="/favicon.png" alt="eL Vision Group Logo" className="w-16 h-16 object-contain" />
              <div>
      ...
      <div className="px-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {fiturUtamaFeatures.map((feature: any, index) => {
          const isLocked = (feature as any).isLocked;
        ...
        <div className="grid grid-cols-2 gap-4">
          {advanceUserFeatures.map((feature: any, index) => {
          const isLocked = (feature as any).isLocked;
          const isMeditationSession = feature.key === 'meditation-sessions';
          const isMeditationLocked = isMeditationSession && !proStatus.isPro;
          const isIgnisQuest = feature.key === 'ignis-quest';
        ...
        <div className="grid grid-cols-2 gap-4">
          {educationFeatures.map((feature: any, index) => {
          const isLocked = (feature as any).isLocked;
          const isMeditationSession = feature.key === 'meditation-sessions';
          const isMeditationLocked = isMeditationSession && !proStatus.isPro;
          const isIgnisQuest = feature.key === 'ignis-quest';
