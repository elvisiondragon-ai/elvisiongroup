...
export default function DevPaymentPage() {
  ...
  }, [showPaymentInstructions, paymentData?.tripay_reference, router, toast, userName, userEmail, phoneNumber, productName, totalAmount, selectedPaymentMethod]);
      ...
      <div className="p-6 pb-4">
        <div className="flex items-center justify-between mb-6">
            ...
            {user ? (
                ...
                <Button variant="outline" onClick={() => router.push('/auth?redirect=/dev')}>Login</Button>
            )}
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-center my-4">
              <img src={devImage.src} alt="Dev Product" className="w-48 h-48 object-contain" />
            </div>
