...
export default function DrelfPaymentPage() {
  ...
  }, [showPaymentInstructions, paymentData?.tripay_reference, router, toast, userName, userEmail, phoneNumber, userAddress, selectedProvince, productName, quantity, totalAmount, selectedPaymentMethod]);
      ...
      <div className="p-6 pb-4">
        <div className="flex items-center justify-between mb-6">
            ...
            {user ? (
                ...
                <Button variant="outline" onClick={() => router.push('/auth?redirect=/drelf')}>Login</Button>
            )}
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-center my-4">
              <img src={drelfImage.src} alt="Drelf Product" className="w-48 h-48 object-contain" />
            </div>
