...
export default function FitfactorPaymentPage() {
  ...
  useEffect(() => {
    ...
    setIsIOS(ios);
    setIsIOSStandalone(iosStandalone);
  }, []);
  ...
  }, [showPaymentInstructions, paymentData?.tripay_reference, router, toast, userName, userEmail, phoneNumber, userAddress, selectedProvince, productName, quantity, totalAmount, selectedPaymentMethod, kota, kodePos]); // Added kota, kodePos to dependencies
            ...
            <h1 className="text-2xl font-bold font-exo bg-gradient-primary bg-clip-text text-transparent">
              ...
              <div className="px-6 space-y-6">
                <div className="text-center my-4">
                  ...
                  <Card className="bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-black p-3 rounded-md text-center cursor-pointer" onClick={() => router.push('/whatispro')}>
      ...
      <div className="p-6 pb-4">
        <div className="flex items-center justify-between mb-6">
            ...
            {user ? (
                ...
                <Button variant="outline" onClick={() => router.push('/auth?redirect=/fitfactor')}>Login</Button>
            )}
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-center my-4">
              <img src={fitfactorImage.src} alt="Fitfactor Product" className="w-48 h-48 object-contain" />
            </div>
