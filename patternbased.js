...
Respond dengan JSON format:
{
  ...
  "insights": ["insight 1 - analisis pola Elite Habit dan spiritual", "insight 2 - psikologi mendalam", "insight 3 - dari data provided"],
  "spiritualRecommendation": ["🔥 Verse to use: Pick VERSE OPTIONS list Verse number and Verse name (example Verse 1: Space Hill or Verse 2: Lucid Beach or Verse 4: Prosperity Stream Vol.1, etc that match with solutions) yang diperlukan user (verse benefit) how many times sehari selama berapa hari", "⭐️ Elite habit: pick yang cocok DAFTAR ELITE HABITS TERSEDIA dengan caranya", "🚀 Enhance spiritual journal: Berikan saran cara menulis jurnal yang lebih bermanfaat bagi user", "⚠️ Extra advice: Beri saran lain out of the box seperti jalan di alam, sedekah, hiking, dan sebagainya", "👑 Quote Anda: Cari Quote dari orang terkenal yang relevan, kreatif lah cari yang membuka mata user dari berbagai sumber"]
}`;
