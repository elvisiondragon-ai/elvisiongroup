-- REPLACE activate_pro_subscription TO ALLOW EXTENSIONS
...
BEGIN
  ...
  IF existing_sub.id IS NOT NULL THEN
    ...
    SET 
        ...
        amount_paid = amount_paid + waiting_record.amount_paid,
  ...
  ELSE
    ...
    INSERT INTO public.pro_subscriptions (
      ...
      'active', p_tripay_reference, NOW(), subscription_end_date, calculated_days,
