-- This script reverts the changes made by the migration 20251029_final_fix_total_verses_increment.sql

-- Step 1: Drop the award_audio_xp function
DROP FUNCTION IF EXISTS public.award_audio_xp(uuid, integer, boolean);

-- Step 2: Restore the original award_xp function
