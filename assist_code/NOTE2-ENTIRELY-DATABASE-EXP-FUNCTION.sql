-- COMPLETE XP SYSTEM FIX - Based on working NOTE1-EXPSYSTEM-ALL.sql
-- Updated for current profiles schema with analytics columns
...
BEGIN
    ...
    FOR trigger_record IN
        ...
        AND event_object_table IN ('user_activities', 'xp_transactions', 'profiles')
    LOOP
...
-- Create the working version with NO triggers
...
BEGIN
  ...
  -- Update profile with new XP, level AND increment counters in ONE update
