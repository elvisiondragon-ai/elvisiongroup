-- ===============================================
-- FIX DAYS_REMAINING TABLE SYNC (NO TRIAL LOGIC)
-- Keep everything the same, just fix the sync issues
-- ===============================================
...
-- 5. Create function to sync all existing data
...
BEGIN
  ...
  -- Insert all current subscription data
  FOR sub_record IN 
    SELECT 
      ps.*,
      p.email,
